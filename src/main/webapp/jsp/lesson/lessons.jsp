...
<div style="width: 800px" class="container panel panel-footer">
    <h3 style="text-align: center">List Lessons For ${title}</h3>
    ...
    <c:if test="${lessons.size() != 0}">
        <table class="table table-bordered table-responsive">
            <tr>
                ...
                <th class="col-sm-2 text-center ${groupId == null ? "" : "hidden"}">Group</th>
                <th class="col-sm-2 text-center ${teacherId == null ? "" : "hidden"}">Teacher</th>
                <th class="col-sm-2 text-center ${roomId == null ? "" : "hidden"}">Room</th>
            ...
            <c:forEach items="${lessons}" var="lesson">
                <tr valign="top">
                    ...
                    <td class="text-center ${teacherId == null ? "" : "hidden"}">
                        <span>${lesson.teacher.firstName}${lesson.teacher.lastName}</span></td>
    ...
    <input style="margin-left: 35%; margin-top: 5%" class="btn btn-default" type="button" onclick="parent.location='/home_page'"
